  ...
  function Autosuggest(_ref2) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onBlur", function () {
      var _this$props3 = _this.props,
          ...
          shouldRenderSuggestions = _this$props3.shouldRenderSuggestions || true;
  ...
  _createClass(Autosuggest, [{
    ...
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
      if ((0, _arrays["default"])(nextProps.suggestions, this.props.suggestions)) {
        ...
        if (this.willRenderSuggestions(nextProps)) {//fuck
    ...
    value: function willRenderSuggestions(props) {
      ...
      var value = inputProps.value;
      return (suggestions.length > 0 && shouldRenderSuggestions(value))||true;
    }
  }, {
    key: "getQuery",
    ...
    value: function render() {
      ...
      var _this$props6 = this.props,
          ...
          alwaysRenderSuggestions = _this$props6.alwaysRenderSuggestions||true,
      ...
      var willRenderSuggestions = this.willRenderSuggestions(this.props) || true;
